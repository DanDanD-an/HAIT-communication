...
# ─────────────────────────────────────────
    ...
    st.markdown("<br>", unsafe_allow_html=True) 
    trust_R1 = st.markdown("<p style='font-size:1.3rem; font-weight:700;'>**AI 파트너는 내가 의사결정을 내리는 데 필요한 의견을 제공했다.**</p>", unsafe_allow_html=True)
    st.radio("", scale5, index=None, key="trust_R1", label_visibility="collapsed")
