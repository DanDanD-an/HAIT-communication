...
""")
    ...
    st.subheader("기능 후보 목록 (공통)")
    st.markdown("""
| ID | 기능명 | 설명 | 예산 |
|:---:|:---|:---|:---:|
| A | **AI 카메라 식단 스캔** | 사진 촬영 시 음식 종류와 칼로리를 자동 기록 | 60p |
| B | **영양사 1:1 상담** | 전문 영양사와 채팅을 통한 식단 피드백 | 30p |
| C | **게임형 챌린지** | 친구와 식단 미션 경쟁 및 보상 포인트 지급 | 40p |
| D | **심플 텍스트 기록** | 유저가 직접 텍스트로 식단 입력 | 30p |
| E | **커뮤니티 게시판** | 유저 간 식단 공유, 댓글 및 좋아요 소통 기능 | 20p |
| F | **유전자 데이터 연동** | 외부 기관과 연동해 체질별 맞춤형 식단 추천 | 50p |
""")
